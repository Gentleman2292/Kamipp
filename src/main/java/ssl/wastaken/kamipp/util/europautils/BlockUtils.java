...
public class BlockUtils implements IMinecraft
{
    ...
    public static boolean placeBlockOnHole(final BlockPos pos, final boolean swing) {
        ...
        final Vec3d hitVec = new Vec3d((Vec3i)neighbour).add(Double.longBitsToDouble(Double.doubleToLongBits(14.310729552844377) ^ 0x7FCC9F17F1A6BC0FL), Double.longBitsToDouble(Double.doubleToLongBits(2.5630748913417127) ^ 0x7FE4812D689C175EL), Double.longBitsToDouble(Double.doubleToLongBits(15.030794407170665) ^ 0x7FCE0FC448D7653BL)).add(new Vec3d(opposite.getDirectionVec()).scale(Double.longBitsToDouble(Double.doubleToLongBits(3.1349750344517173) ^ 0x7FE9146DCA75F909L)));
