...
import ssl.wastaken.kamipp.features.gui.font.CustomFont;
...
import java.awt.Font;
    ...
    {
        public Font font;
        public ssl.wastaken.kamipp.features.gui.font.CustomFont defaultFont;
        public ssl.wastaken.kamipp.features.gui.font.CustomFont boldFont;
        public ssl.wastaken.kamipp.features.gui.font.CustomFont italicFont;
        public ssl.wastaken.kamipp.features.gui.font.CustomFont boldItalicFont;

        public FontRenderer(final Font font) {
            this.font = font;
            this.defaultFont = new ssl.wastaken.kamipp.features.gui.font.CustomFont(font);
            this.boldFont = new ssl.wastaken.kamipp.features.gui.font.CustomFont(font.deriveFont(1));
            this.italicFont = new ssl.wastaken.kamipp.features.gui.font.CustomFont(font.deriveFont(2));
        }
        ...
        public int drawText(final String text, final float x, final float y, final int color, final boolean ignoreColor) {
            ...
            if (text.contains("§")) {
                final String[] parts = text.split("§");
                ssl.wastaken.kamipp.features.gui.font.CustomFont currentFont = this.defaultFont;
                float width = (float) Double.longBitsToDouble(Double.doubleToLongBits(1.0591535192481754E307) ^ 0x7FAE2A6AE450258FL);
                ...
                for (int index = 0; index < parts.length; ++index) {
                    ...
                    if (!part.isEmpty()) {
                        if (index == 0) {
                            currentFont.drawString(part, width, (float) Double.longBitsToDouble(Double.doubleToLongBits(1.7403185334101932E308) ^ 0x7FEEFA8BF6FD04E3L), currentColor);
