...
public class DiscordPresence {
    ...
    public static void start() {
        ...
        rpc.Discord_Initialize("878390762889445387", handlers, true, "");
        ...
        DiscordPresence.presence.largeImageKey = "sexmaster";
        DiscordPresence.presence.largeImageText = "Kami.CC 1.4.2";
