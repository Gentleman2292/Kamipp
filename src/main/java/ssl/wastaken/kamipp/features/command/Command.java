package ssl.wastaken.kamipp.features.command;
...
public abstract class Command
    ...
    public static void sendMessage(String message) {
        Command.sendSilentMessage(Kami.commandManager.getClientMessage() + " " + "\u00a7r" + message);
    }
    ...
    public static String getCommandPrefix() {
        return Kami.commandManager.getPrefix();
    }
