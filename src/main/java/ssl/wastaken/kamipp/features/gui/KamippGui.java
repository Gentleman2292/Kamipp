...
public class KamippGui
        extends GuiScreen {
    private static KamippGui SexMasterGui;
    private static KamippGui INSTANCE;
    ...
    public static KamippGui getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new KamippGui();
        }
        return INSTANCE;
    }

    public static KamippGui getClickGui() {
        return KamippGui.getInstance();
    }
