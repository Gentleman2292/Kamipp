package ssl.wastaken.kamipp.features.gui.components;
...
import ssl.wastaken.kamipp.features.gui.components.items.buttons.Button;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.open) {
            ...
            if (ClickGui.getInstance().outline.getValue().booleanValue()) {
                if (ClickGui.getInstance().rainbowRolling.getValue().booleanValue()) {
                    ...
                    GlStateManager.shadeModel((int)7425);
                    GL11.glBegin((int)2);
                    Color outlineColor = ClickGui.getInstance().colorSync.getValue() != false ? new Color(Colors.INSTANCE.getCurrentColorHex()) : new Color(Kami.colorManager.getColorAsIntFullAlpha());
        ...
        Kami.textManager.drawStringWithShadow(this.getName(), (float)this.x + 3.0f, (float)this.y - 4.0f - (float) KamippGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            KamippGui.getClickGui().getComponents().forEach(component -> {
                if (component.drag) {
