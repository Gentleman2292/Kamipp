package ssl.wastaken.kamipp.features;
...
public class Feature
    ...
    public TextManager renderer = Kami.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof KamippGui) {
            KamippGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
