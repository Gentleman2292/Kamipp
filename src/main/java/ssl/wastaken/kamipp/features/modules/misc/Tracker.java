...
import ssl.wastaken.kamipp.event.events.ConnectionEvent;
...
public class Tracker
    ...
    public void onPacketSend(PacketEvent.Send event) {
        if (!Tracker.fullNullCheck() && this.isOn() && event.getPacket() instanceof CPacketPlayerTryUseItemOnBlock) {
            ...
            if (Tracker.mc.player.getHeldItem(packet.hand).getItem() == Items.END_CRYSTAL && !AutoCrystal.placedPos.contains(packet.position)) {
    ...
    public void onSpawnEntity(Entity entity) {
        ...
        if (entity instanceof EntityEnderCrystal) {
            if (this.manuallyPlaced.contains(entity.getPosition().down())) {
