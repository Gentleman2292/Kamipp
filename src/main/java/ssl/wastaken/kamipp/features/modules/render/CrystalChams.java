...
public class CrystalChams
    ...
    public Setting<Boolean> chams = this.register(new Setting<Boolean>("PhobosChams", false));
    ...
    public void onUpdate() {
        for (Entity crystal : CrystalChams.mc.world.loadedEntityList) {
    ...
    public void onReceivePacket(PacketEvent.Receive event) {
        if (event.getPacket() instanceof SPacketDestroyEntities) {
            ...
            for (int id : packet.getEntityIDs()) {
                Entity entity = CrystalChams.mc.world.getEntityByID(id);
