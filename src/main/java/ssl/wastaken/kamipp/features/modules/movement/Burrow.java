...
import ssl.wastaken.kamipp.util.BurrowUtil;
...
public class Burrow extends Module
{
    ...
    public Burrow() {
        super("Burrow", "TPs you into a block", Category.MOVEMENT, true, false, false);
    ...
    public void onEnable() {
        ...
        switch (this.mode.getValue()) {
            ...
            case PISTON: {
                this.returnBlock = Blocks.PISTON;
                break;
            }
        }
    ...
    public void onUpdate() {
        switch (this.mode.getValue()) {
            ...
            case PISTON: {
                if (BurrowUtil.findHotbarBlock(BlockPistonBase.class) == -1) {
                    Command.sendMessage("Can't find piston in hotbar!");
                    this.toggle();
                    return;
                }
                break;
        ...
        switch (this.mode.getValue()) {
            ...
            case PISTON: {
                BurrowUtil.switchToSlot(BurrowUtil.findHotbarBlock(BlockPistonBase.class));
                break;
            }
        }
