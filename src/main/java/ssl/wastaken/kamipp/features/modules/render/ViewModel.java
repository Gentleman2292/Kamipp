...
class ViewModel extends Module {
    ...
    public Setting < Double > mainX = this.register ( new Setting <> ( "MainX" , 0.0 , - 2.0 , 4.0 , v -> settings.getValue ( ) == Settings.TRANSLATE ) );
    public Setting < Double > mainY = this.register ( new Setting <> ( "MainY" , - 0.0 , - 3.0 , 3.0 , v -> settings.getValue ( ) == Settings.TRANSLATE ) );
    public Setting < Double > mainZ = this.register ( new Setting <> ( "MainZ" , - 0.0 , - 5.0 , 5.0 , v -> settings.getValue ( ) == Settings.TRANSLATE ) );
    public Setting < Double > offX = this.register ( new Setting <> ( "OffX" , 0.0 , - 2.0 , 4.0 , v -> settings.getValue ( ) == Settings.TRANSLATE ) );
    public Setting < Double > offY = this.register ( new Setting <> ( "OffY" , - 0.0 , - 3.0 , 3.0 , v -> settings.getValue ( ) == Settings.TRANSLATE ) );
    public Setting < Double > offZ = this.register ( new Setting <> ( "OffZ" , - 0.0 , - 5.0 , 5.0 , v -> settings.getValue ( ) == Settings.TRANSLATE ) );
