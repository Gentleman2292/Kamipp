...
public class NewOffhand
        extends Module {
    private static NewOffhand instance;
    ...
    public NewOffhand() {
        super("NewOffhand", "Allows you to switch up your Offhand.", Module.Category.COMBAT, true, false, false);
        instance = this;
    }

    public static NewOffhand getInstance() {
        if (instance == null) {
            instance = new NewOffhand();
        }
        return instance;
    }
